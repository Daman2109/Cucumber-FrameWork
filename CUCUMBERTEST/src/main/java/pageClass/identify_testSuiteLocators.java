...
public class identify_testSuiteLocators {
...
By title_box = By.xpath("/html/body/div[1]/div[3]/div[2]/div/section/section/div/section[2]/div[2]/div/section/form/div[1]/div[2]/div/div/div/input");
By create_button =By.xpath("/html/body/div[1]/div[3]/div[2]/div/section/section/div/section[2]/div[2]/div/section/div/div/button[1]");
By verification =By.xpath("//div[text()='Test Suite has been saved successfully.']");

public identify_testSuiteLocators(WebDriver driver1_x)   //Made constructor and passed reference variable
{
	driver = driver1_x;	
}
